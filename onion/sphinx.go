...
func (hd *HopData) Encode(w io.Writer) error {
	...
	if err := binary.Write(w, binary.BigEndian, hd.ForwardTokenAmount); err != nil {
		return err
	}
...
func (hd *HopData) Decode(r io.Reader) error {
	...
	if err := binary.Read(r, binary.BigEndian, &hd.ForwardTokenAmount); err != nil {
		return err
	}
