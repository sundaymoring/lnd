...
type chainConfig struct {
	...
	MinTokenHTLC		lnwire.MilliSatoshi `long:"mintokenhtlc" description:"The smallest token HTLC we are willing to forward on our channels, in millisatoshi"`
}
...
func loadConfig() (*config, error) {
	defaultCfg := config{
		...
		Bitcoin: &chainConfig{
			...
			Node:          "btcd",
			MinTokenHTLC:	defaultBitcoinTokenMinHTLCMSat,
		},
		BtcdMode: &btcdConfig{
			Dir:     defaultBtcdDir,
