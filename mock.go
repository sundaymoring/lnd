...
func (m *mockSigner) SignOutputRaw(tx *wire.MsgTx,
	...
	sig, err := txscript.RawTxInWitnessSignature(tx, signDesc.SigHashes,
		...
		privKey, signDesc.Output.TokenId[:], signDesc.Output.TokenValue)
	if err != nil {
		return nil, err
	}
...
func (m *mockSigner) ComputeInputScript(tx *wire.MsgTx,
	...
	witnessScript, err := txscript.WitnessSignature(tx, signDesc.SigHashes,
		...
		signDesc.HashType, privKey, true, signDesc.Output.TokenId[:], signDesc.Output.TokenValue)
	if err != nil {
		return nil, err
	}
...
func (*mockChainIO) GetTokenId(symbol string) (*wire.TokenId, error){
	return nil,nil
}

func (*mockChainIO)GetTokenSymbol(tokenId *wire.TokenId) (string, error){
	return "", nil
}
